...
namespace LinhKienShop.Models
{
    public class ApplicationDbContext:DbContext
    {
        ...
        public  DbSet<DonHangMaGiamGium> DonHangMaGiamGia { get; set; } = null!;
        ...
        public  DbSet<TrangThaiDonHang> TrangThaiDonHangs { get; set; } = null!;
        public  DbSet<TrangThaiThanhToan> TrangThaiThanhToans { get; set; } = null!;
